...
(function () {
  ...
  ReferrerCtrl = (function () {
    function ReferrerCtrl($scope, $rootScope, $log, $location, ngDialog, ReferrerService) {
      this.$scope = $scope;
      ...
      this.referrers = [];
      this.referrer = this.$scope.referrer || {};
      this.pager = {};
      this.dialog = {};
      this.exportPager = {};
      this.exportUrl = baseUrl + "/referrer/excel";
      this.$scope.referrerOptions = {
        data: 'pager.list',
        enablePaging: true,
        showFooter: true,
        multiSelect: false,
    ...
    ReferrerCtrl.prototype.toDetail = function (referrer) {
      this.$scope.referrer = angular.copy(referrer);
      this.dialog = this.ngDialog.open({
        template: 'referrerDetailDialog',
        className: 'ngdialog-theme-plain custom-width',
        scope: this.$scope
      });
      return this.$log.debug("toDetail()");
