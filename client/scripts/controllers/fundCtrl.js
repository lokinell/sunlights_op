(function () {
  ...
  FundCtrl = (function () {
    function FundCtrl($scope, $rootScope, $log, $location, ProductService, CommonService, CompanyService, SupplierService, ngDialog) {
      this.$scope = $scope;
    ...
    FundCtrl.prototype.updateFund = function (fund) {
      this.$scope.fund = fund;
      this.dialog = this.ngDialog.open({
        template: 'fundSaveDialog',
        className: 'ngdialog-theme-plain custom-width',
        scope: this.$scope
      });
      return this.$log.debug("updateFund()");
    };
